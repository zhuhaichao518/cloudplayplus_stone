...
void FlutterWebRTCPluginRegisterWithRegistrar(
  ...
  flutter_webrtc_plugin::g_main_hwnd_ = ::GetAncestor(
      flutter::PluginRegistrarManager::GetInstance()
          ->GetRegistrar<flutter::PluginRegistrarWindows>(registrar)->GetView()->GetNativeWindow(), GA_ROOT);
    //flutter_webrtc_plugin::g_main_hwnd_ = GetAncestor(FlutterDesktopViewGetHWND(view_ref), GA_ROOT);
    //flutter_webrtc_plugin::g_main_hwnd_ = registrar->GetView()->GetNativeWindow();
#else
