...
// [--message definitions--]
// 消息设计.md
  const int LP_PING = 0x00000000;
  const int RP_PING = 0x00000000;
  const int RP_PONG = 0x00000001;
  const int LP_MOUSE = 0x00000100;
// [--end of message definitions--]

class RTCMessage{
  static bool isEqual(RTCDataChannelMessage message1, RTCDataChannelMessage message2){
